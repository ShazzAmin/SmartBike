...
char http_cmd[] = "POST //script HTTP/1.1\r\nHost: danielzhang.ddns.net\r\nAccept:*/*\r\nAccept-Encoding: gzip, deflate\r\nContent-Length: 113\r\nUser-Agent: runscope/0.1\r\n\r\n<location><time>2017-11-22 20.22</time><latitude>43.472798</latitude><longitude>-80.539651</longitude></location>\r\n\r\n";
...
void setup() {
  ...
  */
  ...
  if(!sim808.connect(TCP,"danielzhang.ddns.net", 80)) {
      ...
      Serial.println("Connect danielzhang.ddns.org success");
  } 
